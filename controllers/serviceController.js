import Service, { find, countDocuments, findById, findByIdAndUpdate } from '../models/Service';
  import Category, { find as _find, findOne } from '../models/Category';
  ...
  export async function   getServices(req, res) {
    try {
      ...
      const services = await find(query)
  ...
  export async function   updateService(req, res) {
    ...
    try {
      let service = await findById(req.params.id);
      ...
      service = await findByIdAndUpdate(req.params.id, req.body, {
        new: true,
        runValidators: true
      });
